...
func HandleValidationError(cfg *config.Config, configPath string, noCacheFlag bool, activeProfile string) error {
	...
	fmt.Println()
	fmt.Printf("It looks like this is your first time running peevetui, or your configuration needs attention.\n")
	...
	fmt.Println("🔄 Please re-run 'peevetui' to start the application with your new configuration.")
	fmt.Println("🚪 Exiting.")
	os.Exit(0)
	return nil
}
