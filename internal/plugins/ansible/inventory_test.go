...
func TestBuildCommunityProxmoxInventory_UsesEnvForSecrets(t *testing.T) {
	...
	require.Contains(t, result.Text, "url: https://pve.example.com:8006")
	require.Contains(t, result.Text, "user: root@pam")
	require.Contains(t, result.Text, "token_id: pvetui")
