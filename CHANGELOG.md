...
- **Config Wizard Auth Validation (All Platforms)**: Read the latest form values at save time and validate the profile currently being edited to avoid stale auth errors.
