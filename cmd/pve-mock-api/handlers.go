...
func handleNodeDisksList(state *MockState) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func handleNodeDiskSmart(state *MockState) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		smart := map[string]interface{}{
			...
			"attributes": []map[string]interface{}{
				{"id": 5, "name": "Reallocated_Sector_Ct", "value": 100, "worst": 100, "thresh": 10, "fail": false, "raw": "0"},
				{"id": 9, "name": "Power_On_Hours", "value": 90, "worst": 90, "thresh": 0, "fail": false, "raw": "12345"},
				{"id": 194, "name": "Temperature_Celsius", "value": 64, "worst": 64, "thresh": 0, "fail": false, "raw": "36"},
			},
		}
...
func handleNodeUpdates(state *MockState) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		updates := []map[string]interface{}{
			...
			},
			{
				...
				"Title":       "OpenZFS Utils",
				"Version":     "2.1.9-pve1",
				"OldVersion":  "2.1.7-pve3",
				"Arch":        "amd64",
				"Description": "OpenZFS command-line utilities",
				"Origin":      "Proxmox",
			},
		}
